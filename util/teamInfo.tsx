export const teamInfo = [
  {
    id: 1,
    name: '김진솔',
    introPhrase: '프론트엔드 개발자로서 창의적인 솔루션을 제공하는 김진솔입니다.',
    historyData: ['코드스테이츠 프론트엔드 부트캠프 44기 수료'],
  ...
  },
  {
    ...
    name: '박무생',
    introPhrase:
      '한 걸음씩 꾸준히 성장하는 개발자가 되고 싶은 박무생입니다. 문제 해결 과정에서 끊임없이 고민하며 결과를 도출하는 것을 좋아하고 단순히 알기보다는 경험을 통한 학습을 중요하게 생각합니다.',
    historyData: [
      '서울과학기술대학교 건축공학과 졸업',
  ...
  },
  {
    id: 3,
    name: '박지원',
    introPhrase: '매일 꾸준하게 성장하는 프론트엔드 개발자 박지원입니다.',
    historyData: [
